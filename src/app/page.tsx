                ...
                <div className="backdrop-blur-sm bg-white/70 border border-white/30 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CreatableSelect<Option, true>
                    ...
                    styles={{
                      ...
                      option: (base, state) => ({
                        ...base,
                        backgroundColor: state.isFocused ? "#d1fae5" : "transparent",
                        color: "#1f2937",
                ...
                <div className="backdrop-blur-sm bg-white/70 border border-white/30 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <CreatableSelect<Option, true>
                    ...
                    styles={{
                      ...
                      option: (base, state) => ({
                        ...base,
                        backgroundColor: state.isFocused ? "#fed7aa" : "transparent",
                        color: "#1f2937",
                        fontWeight: state.isFocused ? "600" : "500",
                        "&:active": {
                  ...
                  <div className="flex items-center mt-3 text-xs text-gray-600 bg-orange-50/80 p-2 rounded-lg">
                    <span className="mr-2">🔢</span>
                    <span>Type numbers only (e.g., 1, 2, 5, 12) and press Enter</span>
                  </div>
                </div>
            </div>
                ...
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">{generatedListings.length} combinations ready</p>
                    </div>
                  </div>
                    ...
                    {generatedListings.map((listing: string, index: number) => (
                      ...
                      >
                        <div className="flex items-start">
                          ...
                          <span className="text-gray-800 font-medium leading-relaxed">{listing}</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="grid gap-3">
                    <div className="flex items-start space-x-3 p-3 rounded-xl bg-gradient-to-r from-blue-50/50 to-indigo-50/50">
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Enter your base product title with <code className="bg-blue-100 text-blue-800 px-1.5 py-0.5 rounded font-mono text-xs">[color]</code>, <code className="bg-green-100 text-green-800 px-1.5 py-0.5 rounded font-mono text-xs">[size]</code>, and <code className="bg-orange-100 text-orange-800 px-1.5 py-0.5 rounded font-mono text-xs">[pack]</code> placeholders
                      </p>
                    </div>
                    <div className="flex items-start space-x-3 p-3 rounded-xl bg-gradient-to-r from-pink-50/50 to-rose-50/50">
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Enter colors separated by commas (like Black, Navy, Fuchsia, Heather Charcoal, etc.)
                      </p>
                    </div>
                    <div className="flex items-start space-x-3 p-3 rounded-xl bg-gradient-to-r from-green-50/50 to-emerald-50/50">
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Select sizes from the dropdown or type custom sizes (like 4XL, XXXS, etc.)
                      </p>
                    </div>
                    <div className="flex items-start space-x-3 p-3 rounded-xl bg-gradient-to-r from-orange-50/50 to-amber-50/50">
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Enter pack quantities as numbers (like 1, 2, 5, 12, etc.) and click generate!
                      </p>
                    </div>
                  </div>
                </div>
